    ...
    <el-row :gutter="20">
      ...
      <el-col :xs="15" :sm="18" :md="19" :lg="20" :xl="20">
        ...
        >
          ...
          >
          <template slot-scope="scope">
            <span>{{ scope.row.childUser.ziMaxNum }}</span>
          </template>
          </el-table-column>
          <el-table-column
            :show-overflow-tooltip="true"
...
<script>
import crudUser from "@/api/system/ziuser";
...
const defaultForm = {
  ...
  phone: null,
  password: '',
  ziOneMaxMoney: "", // 子账号单笔订单最大限制金
  ziMaxMoney: "", // 子账号每日最大订单金额
  ziMaxNum: "", // 子账号一天最大单量
  cancelMaxNum: "",
  cancelMaxMoney: "",
};
export default {
  ...
  methods: {
    ...
    [CRUD.HOOK.afterToCU](crud, form) {
      ...
      // 子账户
      form.ziMaxMoney = form.childUser && form.childUser.ziMaxMoney;
      form.ziMaxNum = form.childUser && form.childUser.ziMaxNum;
      form.ziOneMaxMoney = form.childUser && form.childUser.ziOneMaxMoney;
      form.username = form.phone;
      form.email = form.email + '@qq.com';
    },
    // 新增前将多选的值设置为空
    ...
    [CRUD.HOOK.afterValidateCU](crud) {
      ...
      crud.form.childUser = {
        childCompanyId: crud.form.companyId,
        userId: crud.form.id,
        ziMaxMoney: crud.form.ziMaxMoney,
        ziMaxNum: crud.form.ziMaxNum,
        ziOneMaxMoney: crud.form.ziOneMaxMoney,
      };
      return true;
    },
    // 获取左侧部门数据
