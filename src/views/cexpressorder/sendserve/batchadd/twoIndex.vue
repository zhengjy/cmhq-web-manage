    ...
    <div class="box">
      ...
      <el-form ref="form" label-width="140px" inline  size="small">
        <el-form-item label="当前：">
          <span :class="{ active: hobbydata.includes('1'), 'text': true, }">正向</span>
          <span :class="{ active: hobbydata.includes('2'), 'text': true,}">逆向</span>
        </el-form-item>
        <br/>
        ...
        <el-form-item label="发货地址：" prop="goodsName">
          ...
          <span :class="{ active: true }" @click="toAddAddressList"><i class="el-icon-plus"></i>点击可增加多个发货地址</span>
        </el-form-item>
        <div class="address-warp"  v-for="addressItem in addAddressList">
          <el-button type="danger" icon="el-icon-delete" size="mini" @click="delAddressItem(addressItem.id)" class="del-btn">删除</el-button>
          ...
          <el-form-item label="发货人：" prop="fromName">
            <el-input v-model="addressItem.fromName" style="width: 186px" ></el-input>
          </el-form-item>
          <el-form-item label="发货人手机号：" prop="fromMobile">
            <el-input v-model="addressItem.fromMobile" style="width: 186px"></el-input>
          </el-form-item>
          <el-form-item label="发货分区号：" prop="fromPartitionNumber">
            <el-input v-model="addressItem.fromPartitionNumber" style="width: 186px"></el-input>
          </el-form-item>
    ...
    <div class="box">
      ...
      <el-form ref="form" label-width="140px" inline  size="small">
        ...
        <el-form-item label="收货分区号：" prop="toPartitionNumber">
          <el-input v-model="parsedData.toPartitionNumber" style="width: 186px"></el-input>
        </el-form-item>
  ...
  methods: {
    ...
    parseText(type, addressItem) {
      ...
      addressAnalysis({ text: text }).then((res) => {
        ...
        if (type === 'from') {
          ...
          addressItem.selectedFrom = [result.province, result.city, addressItem.fromArea];
        } else {
    ...
    onSubmit() {
      ...
      this.addAddressList.forEach(item => {
        ...
        getCourierFreightCharge({...item, ...this.parsedData}).then(res => {
          this.loading = false;
