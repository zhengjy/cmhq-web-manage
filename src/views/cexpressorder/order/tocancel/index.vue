        ...
        <template slot-scope="scope">
          ...
          >
            ...
            <div style="text-align: right; margin: 0">
              ...
              <el-button :loading="delLoading" type="primary" size="mini" @click="toCancelCancel(scope.row)">确定</el-button>
            </div>
            <el-button slot="reference" type="text" size="mini">撤销取消</el-button>
          </el-popover>
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    [CRUD.HOOK.beforeRefresh]() {
      // this.query.cancelOrderState = ['-1', 1];
      this.query.pagetype = 3;
